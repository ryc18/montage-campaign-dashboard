    ...
    campaigns: [
        {
            id: 'ist020',
            client: 'institugen',
            name: 'IST020 - Campaign Emails',
            status: 'ACTIVE',
            linkedAutomation: 'IST020: NeuterReady Dog Club Campaign',
            emails: [
                {
                    id: 'ist020-e1',
                    subject: 'When should a dog be neutered? It\'s not always age-based | NeuterReady',
                    sender: 'Matthew Bull | NeuterReady',
                    sent: 185,
                    delivered: 178,
                    bounced: 7,
                    unsubscribed: 0,
                    ...
                    links: [
                        {
                            url: 'https://neuterready.vet/?utm_source=email&utm_medium=edm&utm_campaign=dog_club',
                            uniqueClicks: 8,
                            percentOfClicks: 100.0,
                        },
                    ],
                    locations: [
                        { country: 'New Zealand', code: 'NZ', uniqueOpens: 95, percentOfOpens: 80.51 },
                        { country: 'Australia', code: 'AU', uniqueOpens: 18, percentOfOpens: 15.25 },
                        { country: 'United States', code: 'US', uniqueOpens: 5, percentOfOpens: 4.24 },
                    ],
                    performanceOverTime: [
                        { date: '2026-02-17', campaignsSent: 1, uniqueClicks: 3, uniqueOpens: 42 },
                        { date: '2026-02-18', campaignsSent: 1, uniqueClicks: 2, uniqueOpens: 28 },
                        { date: '2026-02-19', campaignsSent: 1, uniqueClicks: 1, uniqueOpens: 22 },
                        { date: '2026-02-20', campaignsSent: 1, uniqueClicks: 1, uniqueOpens: 18 },
                        { date: '2026-02-23', campaignsSent: 1, uniqueClicks: 1, uniqueOpens: 8 },
                    ],
                },
                {
                    id: 'ist020-e2',
                    subject: 'Why age alone isn\'t a reliable guide for neutering | NeuterReady',
                    sender: 'Matthew Bull | NeuterReady',
                    sent: 370,
                    delivered: 356,
                    bounced: 14,
                    ...
                    locations: [
                        { country: 'New Zealand', code: 'NZ', uniqueOpens: 155, percentOfOpens: 80.31 },
                        { country: 'Australia', code: 'AU', uniqueOpens: 29, percentOfOpens: 15.03 },
                        { country: 'United States', code: 'US', uniqueOpens: 9, percentOfOpens: 4.66 },
                    ],
                    performanceOverTime: [
                        { date: '2026-02-23', campaignsSent: 1, uniqueClicks: 5, uniqueOpens: 68 },
                        { date: '2026-02-24', campaignsSent: 0, uniqueClicks: 3, uniqueOpens: 45 },
                        { date: '2026-02-25', campaignsSent: 0, uniqueClicks: 2, uniqueOpens: 35 },
                        { date: '2026-02-26', campaignsSent: 1, uniqueClicks: 2, uniqueOpens: 25 },
                        { date: '2026-02-27', campaignsSent: 1, uniqueClicks: 2, uniqueOpens: 20 },
                    ],
                },
                {
                    id: 'ist020-e3',
                    subject: 'What these three dogs taught us about timing | NeuterReady',
                    sender: 'Matthew Bull | NeuterReady',
                    sent: 310,
                    delivered: 298,
                    bounced: 12,
                    ...
                    locations: [
                        { country: 'New Zealand', code: 'NZ', uniqueOpens: 130, percentOfOpens: 80.25 },
                        { country: 'Australia', code: 'AU', uniqueOpens: 24, percentOfOpens: 14.81 },
                        { country: 'United States', code: 'US', uniqueOpens: 8, percentOfOpens: 4.94 },
                    ],
                    performanceOverTime: [
                        { date: '2026-02-26', campaignsSent: 1, uniqueClicks: 4, uniqueOpens: 58 },
                        { date: '2026-02-27', campaignsSent: 0, uniqueClicks: 3, uniqueOpens: 38 },
                        { date: '2026-03-02', campaignsSent: 1, uniqueClicks: 2, uniqueOpens: 30 },
                        { date: '2026-03-03', campaignsSent: 0, uniqueClicks: 2, uniqueOpens: 22 },
                        { date: '2026-03-05', campaignsSent: 1, uniqueClicks: 1, uniqueOpens: 14 },
                    ],
                },
                {
                    id: 'ist020-e4',
                    subject: 'Some common questions about neutering timing | NeuterReady',
                    sender: 'Matthew Bull | NeuterReady',
                    sent: 253,
                    delivered: 243,
                    bounced: 10,
                    ...
                    locations: [
                        { country: 'New Zealand', code: 'NZ', uniqueOpens: 97, percentOfOpens: 80.17 },
                        { country: 'Australia', code: 'AU', uniqueOpens: 18, percentOfOpens: 14.88 },
                        { country: 'United States', code: 'US', uniqueOpens: 6, percentOfOpens: 4.96 },
                    ],
                    performanceOverTime: [
                        { date: '2026-03-02', campaignsSent: 1, uniqueClicks: 3, uniqueOpens: 45 },
                        { date: '2026-03-03', campaignsSent: 0, uniqueClicks: 2, uniqueOpens: 30 },
                        { date: '2026-03-05', campaignsSent: 1, uniqueClicks: 2, uniqueOpens: 22 },
                        { date: '2026-03-07', campaignsSent: 0, uniqueClicks: 1, uniqueOpens: 15 },
                        { date: '2026-03-09', campaignsSent: 1, uniqueClicks: 1, uniqueOpens: 9 },
                    ],
                },
                {
                    id: 'ist020-e5',
                    subject: 'The most practical upgrade to your neutering protocol | NeuterReady',
                    sender: 'Matthew Bull | NeuterReady',
                    sent: 230,
                    delivered: 221,
                    bounced: 9,
                    ...
                    locations: [
                        { country: 'New Zealand', code: 'NZ', uniqueOpens: 87, percentOfOpens: 80.56 },
                        { country: 'Australia', code: 'AU', uniqueOpens: 16, percentOfOpens: 14.81 },
                        { country: 'United States', code: 'US', uniqueOpens: 5, percentOfOpens: 4.63 },
                    ],
                    performanceOverTime: [
                        { date: '2026-03-05', campaignsSent: 1, uniqueClicks: 3, uniqueOpens: 40 },
                        { date: '2026-03-06', campaignsSent: 0, uniqueClicks: 2, uniqueOpens: 28 },
                        { date: '2026-03-07', campaignsSent: 0, uniqueClicks: 1, uniqueOpens: 20 },
                        { date: '2026-03-09', campaignsSent: 0, uniqueClicks: 1, uniqueOpens: 12 },
                        { date: '2026-03-10', campaignsSent: 0, uniqueClicks: 0, uniqueOpens: 8 },
                    ],
                },
            ],
        },
